...
// )
// 
// func Test_AWSEnableStorageEncryption_FailureExamples(t *testing.T) {
// 	expectedCode := "aws-documentdb-enable-storage-encryption"
// 
...
// }
// 
// func Test_AWSEnableStorageEncryption_SuccessExamples(t *testing.T) {
// 	expectedCode := "aws-documentdb-enable-storage-encryption"
// 
// 	rule, err := scanner.GetRuleById(expectedCode)
// 	if err != nil {
