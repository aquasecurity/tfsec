...
func Test_AWSEncryptionCustomerKey_FailureExamples(t *testing.T) {
	expectedCode := "aws-documentdb-encryption-customer-key"
...
func Test_AWSEncryptionCustomerKey_SuccessExamples(t *testing.T) {
	expectedCode := "aws-documentdb-encryption-customer-key"
