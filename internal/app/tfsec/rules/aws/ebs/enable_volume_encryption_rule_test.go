...
func Test_AWSEnableVolumeEncryption_FailureExamples(t *testing.T) {
	expectedCode := "aws-ebs-enable-volume-encryption"
...
func Test_AWSEnableVolumeEncryption_SuccessExamples(t *testing.T) {
	expectedCode := "aws-ebs-enable-volume-encryption"
