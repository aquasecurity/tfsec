...
func Test_AzureAccountIdentityRegistered_FailureExamples(t *testing.T) {
	expectedCode := "azure-appservice-account-identity-registered"
...
func Test_AzureAccountIdentityRegistered_SuccessExamples(t *testing.T) {
	expectedCode := "azure-appservice-account-identity-registered"
