...
func Test_AzureDetailedErrorMessagesEnabled_FailureExamples(t *testing.T) {
	expectedCode := "azure-appservice-detailed-error-messages-enabled"
...
func Test_AzureDetailedErrorMessagesEnabled_SuccessExamples(t *testing.T) {
	expectedCode := "azure-appservice-detailed-error-messages-enabled"
