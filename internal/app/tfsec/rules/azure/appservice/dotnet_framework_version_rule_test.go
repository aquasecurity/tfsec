...
func Test_AzureDotnetFrameworkVersion_FailureExamples(t *testing.T) {
	expectedCode := "azure-appservice-dotnet-framework-version"
...
func Test_AzureDotnetFrameworkVersion_SuccessExamples(t *testing.T) {
	expectedCode := "azure-appservice-dotnet-framework-version"
