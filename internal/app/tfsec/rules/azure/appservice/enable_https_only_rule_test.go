...
func Test_AzureEnableHttpsOnly_FailureExamples(t *testing.T) {
	expectedCode := "azure-appservice-enable-https-only"
...
func Test_AzureEnableHttpsOnly_SuccessExamples(t *testing.T) {
	expectedCode := "azure-appservice-enable-https-only"
