...
func Test_AzureFailedRequestTracingEnabled_FailureExamples(t *testing.T) {
	expectedCode := "azure-appservice-failed-request-tracing-enabled"
...
func Test_AzureFailedRequestTracingEnabled_SuccessExamples(t *testing.T) {
	expectedCode := "azure-appservice-failed-request-tracing-enabled"
