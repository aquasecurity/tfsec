...
func Test_AzureFtpDeploymentsDisabled_FailureExamples(t *testing.T) {
	expectedCode := "azure-appservice-ftp-deployments-disabled"
...
func Test_AzureFtpDeploymentsDisabled_SuccessExamples(t *testing.T) {
	expectedCode := "azure-appservice-ftp-deployments-disabled"
