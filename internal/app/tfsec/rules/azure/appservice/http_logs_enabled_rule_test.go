...
func Test_AzureHttpLogsEnabled_FailureExamples(t *testing.T) {
	expectedCode := "azure-appservice-http-logs-enabled"
...
func Test_AzureHttpLogsEnabled_SuccessExamples(t *testing.T) {
	expectedCode := "azure-appservice-http-logs-enabled"
