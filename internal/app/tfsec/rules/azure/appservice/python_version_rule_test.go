...
func Test_AzurePythonVersion_FailureExamples(t *testing.T) {
	expectedCode := "azure-appservice-python-version"
...
func Test_AzurePythonVersion_SuccessExamples(t *testing.T) {
	expectedCode := "azure-appservice-python-version"
