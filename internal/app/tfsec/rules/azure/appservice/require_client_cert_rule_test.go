...
func Test_AzureRequireClientCert_FailureExamples(t *testing.T) {
	expectedCode := "azure-appservice-require-client-cert"
...
func Test_AzureRequireClientCert_SuccessExamples(t *testing.T) {
	expectedCode := "azure-appservice-require-client-cert"
