...
func Test_AzureUseSecureTlsPolicy_FailureExamples(t *testing.T) {
	expectedCode := "azure-appservice-use-secure-tls-policy"
...
func Test_AzureUseSecureTlsPolicy_SuccessExamples(t *testing.T) {
	expectedCode := "azure-appservice-use-secure-tls-policy"
