...
func Test_AzureLimitRoleActions_FailureExamples(t *testing.T) {
	expectedCode := "azure-authorization-limit-role-actions"
...
func Test_AzureLimitRoleActions_SuccessExamples(t *testing.T) {
	expectedCode := "azure-authorization-limit-role-actions"
