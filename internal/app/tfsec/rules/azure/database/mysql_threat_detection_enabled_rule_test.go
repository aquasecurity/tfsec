...
func Test_DatabaseMysqlThreatDetectionEnabled_FailureExamples(t *testing.T) {
	expectedCode := "azure-database-mysql-threat-detection-enabled"
...
func Test_DatabaseMysqlThreatDetectionEnabled_SuccessExamples(t *testing.T) {
	expectedCode := "azure-database-mysql-threat-detection-enabled"
