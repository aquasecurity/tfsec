...
func Test_AzureEnableHttp2_FailureExamples(t *testing.T) {
	expectedCode := "azure-functionapp-enable-http2"
...
func Test_AzureEnableHttp2_SuccessExamples(t *testing.T) {
	expectedCode := "azure-functionapp-enable-http2"
