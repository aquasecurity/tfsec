...
func Test_AzureDefenderOnKubernetes_FailureExamples(t *testing.T) {
	expectedCode := "azure-security-center-defender-on-kubernetes"
...
func Test_AzureDefenderOnKubernetes_SuccessExamples(t *testing.T) {
	expectedCode := "azure-security-center-defender-on-kubernetes"
