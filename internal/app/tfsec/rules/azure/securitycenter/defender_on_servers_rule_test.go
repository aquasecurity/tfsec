...
func Test_AzureDefenderOnServers_FailureExamples(t *testing.T) {
	expectedCode := "azure-security-center-defender-on-servers"
...
func Test_AzureDefenderOnServers_SuccessExamples(t *testing.T) {
	expectedCode := "azure-security-center-defender-on-servers"
