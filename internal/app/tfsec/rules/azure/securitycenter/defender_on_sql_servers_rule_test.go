...
func Test_AzureDefenderOnSqlServers_FailureExamples(t *testing.T) {
	expectedCode := "azure-security-center-defender-on-sql-servers"
...
func Test_AzureDefenderOnSqlServers_SuccessExamples(t *testing.T) {
	expectedCode := "azure-security-center-defender-on-sql-servers"
