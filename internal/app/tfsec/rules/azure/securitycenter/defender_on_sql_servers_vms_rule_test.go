...
func Test_AzureDefenderOnSqlServersVMS_FailureExamples(t *testing.T) {
	expectedCode := "azure-security-center-defender-on-sql-servers-vms"
...
func Test_AzureDefenderOnSqlServersVMS_SuccessExamples(t *testing.T) {
	expectedCode := "azure-security-center-defender-on-sql-servers-vms"
