...
`},
		...
		CheckFunc: func(set result.Set, resourceBlock block.Block, _ block.Module) {
			...
			if !resourceTypeAttr.Contains("StorageAccounts", block.IgnoreCase) {
				set.AddResult().
					WithDescription("Resource '%s' does not contain StorageAccounts", resourceBlock.FullName()).
