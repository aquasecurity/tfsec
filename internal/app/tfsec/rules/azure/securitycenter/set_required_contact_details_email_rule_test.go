...
func Test_AzureSetRequiredContactDetailsEmail_FailureExamples(t *testing.T) {
	expectedCode := "azure-security-center-set-required-contact-details-email"
...
func Test_AzureSetRequiredContactDetailsEmail_SuccessExamples(t *testing.T) {
	expectedCode := "azure-security-center-set-required-contact-details-email"
