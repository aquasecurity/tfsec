...
func Test_AzureContainerActivityLogsNotPublic_FailureExamples(t *testing.T) {
	expectedCode := "azure-storage-container-activity-logs-not-public"
...
func Test_AzureContainerActivityLogsNotPublic_SuccessExamples(t *testing.T) {
	expectedCode := "azure-storage-container-activity-logs-not-public"
