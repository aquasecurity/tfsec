...
func init() {
	scanner.RegisterCheckRule(rule.Rule{
		...
		Documentation: rule.RuleDocumentation{
			...
			Impact:      "The container will permanently deleted. if you dont enable container soft delete or provide in blob properties.",
			Resolution:  "Provide Container Delete Retention Policy Block in days in blob properties",
			BadExample: []string{`
