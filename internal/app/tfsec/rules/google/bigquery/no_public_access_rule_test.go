...
func Test_GoogleNoPublicAccess_FailureExamples(t *testing.T) {
	expectedCode := "google-bigquery-no-public-access"
...
func Test_GoogleNoPublicAccess_SuccessExamples(t *testing.T) {
	expectedCode := "google-bigquery-no-public-access"
