...
func Test_GoogleDiskEncryptionCustomerKey_FailureExamples(t *testing.T) {
	expectedCode := "google-compute-disk-encryption-customer-key"
...
func Test_GoogleDiskEncryptionCustomerKey_SuccessExamples(t *testing.T) {
	expectedCode := "google-compute-disk-encryption-customer-key"
