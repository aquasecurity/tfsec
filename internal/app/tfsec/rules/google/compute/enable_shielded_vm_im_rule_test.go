...
func Test_GoogleEnableShieldedVmIM_FailureExamples(t *testing.T) {
	expectedCode := "google-compute-enable-shielded-vm-im"
...
func Test_GoogleEnableShieldedVmIM_SuccessExamples(t *testing.T) {
	expectedCode := "google-compute-enable-shielded-vm-im"
