...
func Test_GoogleEnableVpcFlowLogs_FailureExamples(t *testing.T) {
	expectedCode := "google-compute-enable-vpc-flow-logs"
...
func Test_GoogleEnableVpcFlowLogs_SuccessExamples(t *testing.T) {
	expectedCode := "google-compute-enable-vpc-flow-logs"
