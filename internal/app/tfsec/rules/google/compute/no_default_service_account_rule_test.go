package compute
 ...
 func Test_GoogleNoDefaultServiceAccount_FailureExamples(t *testing.T) {
 	expectedCode := "google-compute-no-default-service-account"
 ...
 func Test_GoogleNoDefaultServiceAccount_SuccessExamples(t *testing.T) {
 	expectedCode := "google-compute-no-default-service-account"
