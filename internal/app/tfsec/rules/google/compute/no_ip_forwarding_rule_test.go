...
func Test_GoogleNoIpForwarding_FailureExamples(t *testing.T) {
	expectedCode := "google-compute-no-ip-forwarding"
...
func Test_GoogleNoIpForwarding_SuccessExamples(t *testing.T) {
	expectedCode := "google-compute-no-ip-forwarding"
