...
// )
// 
// func Test_GoogleNoOsloginOverride_FailureExamples(t *testing.T) {
// 	expectedCode := "google-compute-no-oslogin-override"
// 
...
// }
// 
// func Test_GoogleNoOsloginOverride_SuccessExamples(t *testing.T) {
// 	expectedCode := "google-compute-no-oslogin-override"
// 
// 	rule, err := scanner.GetRuleById(expectedCode)
// 	if err != nil {
