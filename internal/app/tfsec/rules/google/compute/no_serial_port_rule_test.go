...
func Test_GoogleNoSerialPort_FailureExamples(t *testing.T) {
	expectedCode := "google-compute-no-serial-port"
...
func Test_GoogleNoSerialPort_SuccessExamples(t *testing.T) {
	expectedCode := "google-compute-no-serial-port"
