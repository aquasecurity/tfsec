...
// )
// 
// func Test_GoogleUseSecureTlsPolicy_FailureExamples(t *testing.T) {
// 	expectedCode := "google-compute-use-secure-tls-policy"
// 
...
// }
// 
// func Test_GoogleUseSecureTlsPolicy_SuccessExamples(t *testing.T) {
// 	expectedCode := "google-compute-use-secure-tls-policy"
// 
// 	rule, err := scanner.GetRuleById(expectedCode)
// 	if err != nil {
