...
// )
// 
// func Test_GoogleVmDiskEncryptionCustomerKey_FailureExamples(t *testing.T) {
// 	expectedCode := "google-compute-vm-disk-encryption-customer-key"
// 
...
// }
// 
// func Test_GoogleVmDiskEncryptionCustomerKey_SuccessExamples(t *testing.T) {
// 	expectedCode := "google-compute-vm-disk-encryption-customer-key"
// 
// 	rule, err := scanner.GetRuleById(expectedCode)
// 	if err != nil {
