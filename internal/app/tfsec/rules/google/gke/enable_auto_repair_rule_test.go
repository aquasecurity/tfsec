...
func Test_GoogleEnableAutoRepair_FailureExamples(t *testing.T) {
	expectedCode := "google-gke-enable-auto-repair"
...
func Test_GoogleEnableAutoRepair_SuccessExamples(t *testing.T) {
	expectedCode := "google-gke-enable-auto-repair"
