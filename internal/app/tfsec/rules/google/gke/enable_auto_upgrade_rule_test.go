package gke
 ...
 func Test_GoogleEnableAutoUpgrade_FailureExamples(t *testing.T) {
 	expectedCode := "google-gke-enable-auto-upgrade"
 ...
 func Test_GoogleEnableAutoUpgrade_SuccessExamples(t *testing.T) {
 	expectedCode := "google-gke-enable-auto-upgrade"
