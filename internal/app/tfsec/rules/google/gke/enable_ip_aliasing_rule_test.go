...
func Test_GoogleEnableIpAliasing_FailureExamples(t *testing.T) {
	expectedCode := "google-gke-enable-ip-aliasing"
...
func Test_GoogleEnableIpAliasing_SuccessExamples(t *testing.T) {
	expectedCode := "google-gke-enable-ip-aliasing"
