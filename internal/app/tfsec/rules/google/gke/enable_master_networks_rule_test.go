...
func Test_GoogleEnableMasterNetworks_FailureExamples(t *testing.T) {
	expectedCode := "google-gke-enable-master-networks"
...
func Test_GoogleEnableMasterNetworks_SuccessExamples(t *testing.T) {
	expectedCode := "google-gke-enable-master-networks"
