...
// )
// 
// func Test_GoogleEnableNetworkPolicy_FailureExamples(t *testing.T) {
// 	expectedCode := "google-gke-enable-network-policy"
// 
...
// }
// 
// func Test_GoogleEnableNetworkPolicy_SuccessExamples(t *testing.T) {
// 	expectedCode := "google-gke-enable-network-policy"
// 
// 	rule, err := scanner.GetRuleById(expectedCode)
// 	if err != nil {
