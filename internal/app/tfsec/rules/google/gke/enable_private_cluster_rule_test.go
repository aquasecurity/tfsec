...
func Test_GoogleEnablePrivateCluster_FailureExamples(t *testing.T) {
	expectedCode := "google-gke-enable-private-cluster"
...
func Test_GoogleEnablePrivateCluster_SuccessExamples(t *testing.T) {
	expectedCode := "google-gke-enable-private-cluster"
