...
// )
// 
// func Test_GoogleEnableStackdriverLogging_FailureExamples(t *testing.T) {
// 	expectedCode := "google-gke-enable-stackdriver-logging"
// 
...
// }
// 
// func Test_GoogleEnableStackdriverLogging_SuccessExamples(t *testing.T) {
// 	expectedCode := "google-gke-enable-stackdriver-logging"
// 
// 	rule, err := scanner.GetRuleById(expectedCode)
// 	if err != nil {
