...
func Test_GoogleEnableStackdriverMonitoring_FailureExamples(t *testing.T) {
	expectedCode := "google-gke-enable-stackdriver-monitoring"
...
func Test_GoogleEnableStackdriverMonitoring_SuccessExamples(t *testing.T) {
	expectedCode := "google-gke-enable-stackdriver-monitoring"
