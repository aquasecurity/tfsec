...
// )
// 
// func Test_GoogleNoPublicControlPlane_FailureExamples(t *testing.T) {
// 	expectedCode := "google-gke-no-public-control-plane"
// 
...
// }
// 
// func Test_GoogleNoPublicControlPlane_SuccessExamples(t *testing.T) {
// 	expectedCode := "google-gke-no-public-control-plane"
// 
// 	rule, err := scanner.GetRuleById(expectedCode)
// 	if err != nil {
