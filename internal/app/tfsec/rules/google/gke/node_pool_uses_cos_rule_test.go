...
func Test_GoogleNodePoolUsesCos_FailureExamples(t *testing.T) {
	expectedCode := "google-gke-node-pool-uses-cos"
...
func Test_GoogleNodePoolUsesCos_SuccessExamples(t *testing.T) {
	expectedCode := "google-gke-node-pool-uses-cos"
