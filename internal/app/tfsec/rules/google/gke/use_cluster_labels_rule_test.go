package gke
 ...
 func Test_GoogleUseClusterLabels_FailureExamples(t *testing.T) {
 	expectedCode := "google-gke-use-cluster-labels"
 ...
 func Test_GoogleUseClusterLabels_SuccessExamples(t *testing.T) {
 	expectedCode := "google-gke-use-cluster-labels"
