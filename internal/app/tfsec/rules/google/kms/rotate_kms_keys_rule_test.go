...
func Test_GoogleRotateKmsKeys_FailureExamples(t *testing.T) {
	expectedCode := "google-kms-rotate-kms-keys"
...
func Test_GoogleRotateKmsKeys_SuccessExamples(t *testing.T) {
	expectedCode := "google-kms-rotate-kms-keys"
