...
func Test_KubernetesNoPublicIngress_FailureExamples(t *testing.T) {
	expectedCode := "kubernetes-network-no-public-ingress"
...
func Test_KubernetesNoPublicIngress_SuccessExamples(t *testing.T) {
	expectedCode := "kubernetes-network-no-public-ingress"
