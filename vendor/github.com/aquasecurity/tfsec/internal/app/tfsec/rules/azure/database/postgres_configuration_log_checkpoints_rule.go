...
func init() {
 ...
 `},
		...
		Base: database.CheckPostgresConfigurationLogCheckpoints,
		CheckTerraform: func(resourceBlock block.Block, module block.Module) (results rules.Results) {
			...
			results.Add("Resource does not have a corresponding log configuration enabling 'log_checkpoints'", resourceBlock)
			return results
		},
	})
}
